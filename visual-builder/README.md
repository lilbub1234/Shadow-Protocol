# Shade Visual Builder

The Visual Builder is Shade Framework's revolutionary no-code interface for designing zero-knowledge circuits and privacy applications.
...
│           │                                    │               │
├───────────┴────────────────────────────────────┴───────────────┤
│ Circuit: private_note.shade │ 1,247 constraints │ Modified     │
└────────────────────────────────────────────────────────────────┘
```
...
### Rust Export
```rust
// Generated by Shade Visual Builder
...
import { Circuit, Field, poseidonHash } from '@shade/sdk';
